...
const variants = cva<{
    ...
    'relative isolate inline-flex select-none items-center justify-center border border-transparent font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 enabled:cursor-pointer disabled:cursor-default disabled:bg-transparent disabled:text-foreground/25',
    {
        variants: {
            color: {
